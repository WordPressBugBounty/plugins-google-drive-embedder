<?php
/**
 * Plugin Name: Embedder for Google Drive
 ...
 * License: GPL3
 *
 * @package Embedder For Google Drive
 */
...
class Drive_Embedder_Basic extends Drive_Embedder_Core {
	...
	protected $plugin_version = '5.2.6';
	...
	protected function gdm_mainsection_text() {
		?>
		<p>There are no settings to configure in this free version of Embedder For Google Drive.</p>
		<p>Please
		...
		<p>Our Enterprise version of Embedder For Google Drive integrates Drive much more closely with your WordPress intranet,
